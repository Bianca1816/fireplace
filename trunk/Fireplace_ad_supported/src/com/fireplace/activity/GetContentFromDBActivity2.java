...
public class GetContentFromDBActivity2 extends Activity {
    ...
    void GenData(){
    	...
    	for(int i = 0; i< 10; ++i) {
    		list.add(new ItemSkel("id " + i, "label " + i, "path " + i, "desc " + i, "ptype " + i, "devl " + i));
    	}
    	...
    	//v.setText(json); 
    	Toast.makeText(GetContentFromDBActivity2.this, json, Toast.LENGTH_LONG).show();
    }
    ...
    void LoadData(){
        ...
        try {
            ...
            lv.setOnItemClickListener(new OnItemClickListener() {
              public void onItemClick(AdapterView<?> parent, View view,
                ...
                // When clicked, show a toast with the TextView text
            	  ...
            	  //i.putExtra("desc", currentItem.getDesc());
            	  startActivity(i);
            	  }
            });
        	...
        	Toast.makeText(GetContentFromDBActivity2.this, "Could not connect!", Toast.LENGTH_LONG).show();
        }
    }
