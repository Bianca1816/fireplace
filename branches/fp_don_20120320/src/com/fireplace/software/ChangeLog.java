...
public class ChangeLog {
    ...
    /**
     * This method handles the change log.
     * @param full is set to true if we want the entire change log.
     * @return the entire change log if true, current version changelog if false.
     */
